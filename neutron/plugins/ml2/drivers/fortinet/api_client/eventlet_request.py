...
from neutron.plugins.ml2.drivers.fortinet.api_client import request
...
class LoginRequestEventlet(EventletApiRequest):
    ...
    def session_cookie(self):
        if self.successful():
            print "type(self.value)", type(self.value)
            print "type(self.value.getheader)", type(self.value.getheader)

...
"""Fortinet Driver implements NETCONF over SSHv2 for
...
from neutron.plugins.ml2.drivers.fortinet.fortios import api
...
class FortiOSDriver(object):
    ...
    def connect(self, host, username, password):
        """Connect via fortios RESTful API and initialize session."""
        ...
        if host == '':
            raise Exception(_("Fortinet IP address is not set, "
                              "check the config 'address' in the section"
                              " ml2_fortinet of the plugin.ini file"))

        # Open new http connection
        try:
            self.mgr = api.Authentication(host,
                                          username=username,
                                          password=password)
            self.mgr.auth()
    ...
    def get_fortios_version(self, host, username, password):
        """Show version of FortiOS."""
        LOG.debug(_("def get_fortios_version"))
        pass
        try:
    ...
    def is_virtual_fabric_enabled(self, host, username, password):
        """Show version of NOS."""
        LOG.debug(_("def is_virtual_fabric_enabled"))
        pass
        try:
            mgr = self.connect(host, username, password)
    ...
    def create_network(self, host, username, password, net_id):
        ...
        LOG.debug(_("def create_network"))
        pass
        domain_name = "default"
    ...
    def delete_network(self, host, username, password, net_id):
        ...
        LOG.debug(_("def delete_network"))
        pass
        domain_name = "default"
        name = template.OS_PORT_PROFILE_NAME.format(id=net_id)
        try:
    ...
    def associate_mac_to_network(self, host, username, password,
        ...
        LOG.debug(_("def associate_mac_to_network"))
        pass
        name = template.OS_PORT_PROFILE_NAME.format(id=net_id)
        try:
            mgr = self.connect(host, username, password)
    ...
    def dissociate_mac_from_network(self, host, username, password,
        ...
        LOG.debug(_("def dissociate_mac_from_network"))
        pass
        name = template.OS_PORT_PROFILE_NAME.format(id=net_id)
        try:
            mgr = self.connect(host, username, password)
    ...
    def create_vlan_interface(self, mgr, vlan_id):
        ...
        LOG.debug(_("def create_vlan_interface"))
        pass
    ...
    def delete_vlan_interface(self, mgr, vlan_id):
        ...
        LOG.debug(_("def delete_vlan_interface"))
        pass
    ...
    def get_port_profiles(self, mgr):
        ...
        LOG.debug(_("def get_port_profiles"))
        pass
    ...
    def get_port_profile(self, mgr, name):
        ...
        LOG.debug(_("def get_port_profile"))
        pass
    ...
    def create_port_profile(self, mgr, name):
        ...
        LOG.debug(_("def create_port_profile"))
        pass
    ...
    def delete_port_profile(self, mgr, name):
        ...
        LOG.debug(_("def delete_port_profile"))
        pass
    ...
    def activate_port_profile(self, mgr, name):
        ...
        LOG.debug(_("def activate_port_profile"))
        pass
    ...
    def deactivate_port_profile(self, mgr, name):
        ...
        LOG.debug(_("def deactivate_port_profile"))
        pass
    ...
    def associate_mac_to_port_profile(self, mgr, name, mac_address):
        ...
        LOG.debug(_("def associate_mac_to_port_profile"))
        pass
    ...
    def dissociate_mac_from_port_profile(self, mgr, name, mac_address):
        ...
        LOG.debug(_("def dissociate_mac_from_port_profile"))
        pass
    ...
    def create_vlan_profile_for_port_profile(self, mgr, name):
        ...
        LOG.debug(_("def create_vlan_profile_for_port_profile"))
        pass
    ...
    def configure_l2_mode_for_vlan_profile(self, mgr, name):
        ...
        LOG.debug(_("def configure_l2_mode_for_vlan_profile"))
        pass
    ...
    def configure_trunk_mode_for_vlan_profile(self, mgr, name):
        ...
        LOG.debug(_("def configure_trunk_mode_for_vlan_profile"))
        pass
    ...
    def configure_allowed_vlans_for_vlan_profile(self, mgr, name, vlan_id):
        ...
        LOG.debug(_("def configure_allowed_vlans_for_vlan_profile"))
        pass
    ...
    def remove_port_profile_from_domain(self, mgr, domain_name, name):
        ...
        LOG.debug(_("def remove_port_profile_from_domain"))
        pass
    ...
    def configure_port_profile_in_domain(self, mgr, domain_name, name):
        ...
        LOG.debug(_("def configure_port_profile_in_domain"))
        pass
    ...
    def configure_l2_mode_for_vlan_profile_with_domains(self, mgr, name):
        """Configures L2 mode for VLAN sub-profile."""
        LOG.debug(_("def configure_l2_mode_for_vlan_profile_with_domains"))
        pass
    ...
    def nos_version_request(self, mgr):
        LOG.debug(_("def nos_version_request"))
        pass
    ...
    def virtual_fabric_info(self, mgr):
        LOG.debug(_("def virtual_fabric_info"))
        if True:
            return "enabled"
    ...
    def bind_vrf_to_svi(self, host, username, password, rbridge_id,
                        vlan_id, router_id):
        """binds vrf to a svi."""
        LOG.debug(_("def bind_vrf_to_svi"))
        pass
        router_id = router_id[0:11]
        vrf_name = template.OS_VRF_NAME.format(id=router_id)
        try:
    ...
    def unbind_vrf_to_svi(self, host, username, password, rbridge_id,
        ...
        LOG.debug(_("def unbind_vrf_to_svi"))
        pass
        router_id = router_id[0:11]
        vrf_name = template.OS_VRF_NAME.format(id=router_id)
        try:
    ...
    def configure_rd_for_vrf(self, mgr, rbridge_id, vrf_name, rd):
        ...
        LOG.debug(_("def configure_rd_for_vrf"))
        pass
    ...
    def configure_address_family_for_vrf_v1(self, mgr, rbridge_id, vrf_name):
        ...
        LOG.debug(_("def configure_address_family_for_vrf_v1"))
        pass
    ...
    def configure_address_family_for_vrf(self, mgr, rbridge_id, vrf_name):
        """configure ipv4 address family to vrf  on rbridge."""
        LOG.debug(_("def configure_address_family_for_vrf"))
        pass
    ...
    def configure_svi_with_ip_address(self, mgr, rbridge_id,
        ...
        LOG.debug(_("def configure_svi_with_ip_address"))
        pass
    ...
    def add_vrf_to_svi(self, mgr, rbridge_id, vlan_id, vrf_name):
        ...
        LOG.debug(_("def add_vrf_to_svi"))
        pass
    ...
    def delete_vrf_from_svi(self, mgr, rbridge_id, vlan_id, vrf_name):
        ...
        LOG.debug(_("def delete_vrf_from_svi"))
        pass
